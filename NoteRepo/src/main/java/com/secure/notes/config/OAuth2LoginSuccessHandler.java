...
import com.secure.notes.secure.service.UserDetailsImpl;
...
public class OAuth2LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
            ...
            ServletException , IOException
    {
                ...
                userService.findByEmail(email)
                        .ifPresentOrElse(user -> {
                            ...
                            Optional<Role> userRole =
                                    roleRepository.findByRoleName(AppRole.ROLE_USER);//Fetch existing role
                                    if(userRole.isPresent()){
                                        newUser.setRole(userRole.get()); //Set existing role
                                    }else {
                                        //Haldle the case where the role is not found
        ...
        System.out.println("OAuth2LoginSeccessHandler: "+ username +" : "+email);

        //Create UserDetailsIml instance

...
import com.secure.notes.secure.jwt.AuthEntryPointJwt;
import com.secure.notes.secure.jwt.AuthTokenFilter;
...
public class SecurityConfig {
   ...
   /* @Autowired
    private AuthEntryPointJwt unauthoriwedHandler;
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws
     ...
     http.csrf(csrf -> csrf.csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
        ...
        http.authorizeHttpRequests((request)
                ...
                .requestMatchers("/api/auth/public/**").permitAll()
                .anyRequest().authenticated());
        http.exceptionHandling(exception -> exception.authenticationEntryPoint(unauthoriwedHandler));
        http.addFilterBefore(authenticationJwtTokenFilter(),
                UsernamePasswordAuthenticationFilter.class);
